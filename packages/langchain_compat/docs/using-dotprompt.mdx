...
> **🚧 COMING SOON**  
> DotPrompt integration is currently in development and will be available in a future release of Dartantic.
...
parsing and validation of the .prompt files, and Dartantic will support executing them.
