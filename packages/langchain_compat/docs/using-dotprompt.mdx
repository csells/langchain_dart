...
Use Google's [DotPrompt specification](https://google.github.io/dotprompt) to define prompts with metadata, templates, and validation.
...
- [DotPrompt demo](https://github.com/davidmigloz/langchain_dart/blob/main/packages/langchain_compat/example/bin/dotprompt.dart)
- [DotPrompt package](https://pub.dev/packages/dotprompt_dart)

## Next Steps

- [Basic Agent Usage](/basic-agent-usage) - Agent fundamentals
- [System Prompts](/system-prompts) - Built-in prompt management
