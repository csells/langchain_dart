...
- [Embeddings demo](https://github.com/davidmigloz/langchain_dart/blob/main/packages/langchain_compat/example/bin/embeddings.dart)
- [Basic usage](https://github.com/davidmigloz/langchain_dart/blob/main/packages/langchain_compat/example/bin/agent.dart)
