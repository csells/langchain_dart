...
- [Custom provider demo](https://github.com/davidmigloz/langchain_dart/blob/main/packages/langchain_compat/example/bin/custom_provider.dart)
- [Provider list](https://github.com/davidmigloz/langchain_dart/blob/main/packages/langchain_compat/example/bin/provider_models.dart)
