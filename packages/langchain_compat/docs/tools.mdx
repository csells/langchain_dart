...
Tools are functions that extend AI agents with custom capabilities.
...
- [MCP tools](https://github.com/davidmigloz/langchain_dart/blob/main/packages/langchain_compat/example/mcp_client.dart)

## Next Steps

- [Tool Calling](/tool-calling) - Using tools with agents
- [Typed Output](/typed-output) - Structured output with tools
- [Provider Capabilities](/provider-capabilities) - Tool support by provider